...
#File used to make view for add new achievement into database, uses add_achievement_html as template

#######################################################################################################

import sys, session, cgi, MySQLdb, redirect, sql_handler as sql, html_template as html, add_achievement_html as form

...
#HTML template file for view of adding new achievement for user
...
def open_form():
    print"""        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-offset-4">
                    <div class="well">
                        <form method="post" action="add_achievement_update.py">
                            <fieldset>"""
    return
...
def print_fields():
    ...
    print_a_field("AchievementName", "Achievement Name", "Enter Achievement Name")
    print_a_field("RewardBody", "Affiliated Company", "Enter Company Name")
    return
...
def close_form():
    print"""                            <div class="form-group">
                                <div class="col-lg-4 col-lg-offset-4">
                                    <button type="submit" class="btn btn-primary btn-block">Create Achievement</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>

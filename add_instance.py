...
#File used to generate add instance view for insertion of new instance to database, 
#uses add_instance_html as template

#######################################################################################################

import sys, session, cgi, MySQLdb, redirect, sql_handler as sql, html_template as html, add_instance_html as form
